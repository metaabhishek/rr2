...
export default class RewardsList extends LightningElement {
  ...
  getEmployee()
    ...
    // empDetails({empId:this.employeeId})
    // .then(result=>{
    //     availablePoints=result[0].Monetization_Points__c;
    //     console.log('Available Points are '+ availablePoints);

    //     if (reward.Required_Reward_Points__c > availablePoints) {
    //     console.log('Difference is '+reward.Required_Reward_Points__c > availablePoints);
